...
if __name__ == '__main__':
    ...
    parser.add_argument('--celeba_crop_size', type=int, default=950, help='crop size for the CelebA dataset')
    ...
    parser.add_argument('--batch_size', type=int, default=1, help='mini-batch size')   #16
    parser.add_argument('--num_iters', type=int, default=40000, help='number of total iterations for training D') #200000
    ...
    parser.add_argument('--selected_attrs', '--list', nargs='+', help='selected attributes for the CelebA dataset',
                        default=['Formal_Shoes', 'Sports_Shoes', 'Flip_Flops', 'Flats', 'Heels'])        #['Purple', 'Red', 'Blue', 'Black', 'White']

    # Test configuration.
    parser.add_argument('--test_iters', type=int, default=30000, help='test model from this step')
    ...
    parser.add_argument('--attr_path', type=str, default='data/celeba/footwear.txt')
